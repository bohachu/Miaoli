package MovieFrame {
	...
	public class MovieFrame02 extends MovieChangePhotoAndObjectPropertyModify {
		...
		public function MovieFrame02(photoBitmapIn:Bitmap = null, isSoundEnableIn:Boolean = true, isPlayOnAddedIn:Boolean = true, isUseIphone5LayoutIn:Boolean = false) {
			// constructor code
...
//			}
			...
			stageMovie = new MovieFrame02MovieClip();
