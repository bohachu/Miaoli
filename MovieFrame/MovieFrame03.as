package MovieFrame {
	...
	public class MovieFrame03 extends MovieChangePhotoAndObjectPropertyModify {
		...
		public function MovieFrame03(photoBitmapIn:Bitmap = null, isSoundEnableIn:Boolean = true, isPlayOnAddedIn:Boolean = true, isUseIphone5LayoutIn:Boolean = false) {
			// constructor code
...
//			}
			...
			stageMovie = new MovieFrame03MovieClip();
